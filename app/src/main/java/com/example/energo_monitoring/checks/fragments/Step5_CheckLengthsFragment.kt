...
import com.example.energo_monitoring.checks.fragments.devices.adapters.LengthsStateAdapter
...
//            presenter.insertDataToDb(context)
        ...
        val dataBundle = SharedPreferencesManager.getClientDataBundle(context)
        if (dataBundle.deviceFlowTransducers.isEmpty()) {
            return binding.root
        }

        presenter = CheckLengthOfStraightLinesPresenter(this, dataBundle, dataId)
