...
import com.example.energo_monitoring.checks.presenters.CheckMainPresenter
...
class Step1_ProjectPhotoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.cardViewTakePhoto.setOnClickListener {
            ...
            LoadImageManager.takePhoto(requireContext(), presenter.takePhotoResult, lastCreatedPath)
        }
