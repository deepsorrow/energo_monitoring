...
public class DeviceInspectionPresenter {
    ...
    public DeviceInspectionPresenter(Step4_DeviceInspectionFragment fragment, ArrayList<DeviceInfo> devices) {
        this.fragment = fragment;
        this.devices = devices;

//        Navigation
//                .findNavController(fragment.getView())
//                .navigate(R.id.action_step4_DeviceInspectionFragment_to_device_navigation);
    }
