...
import com.example.energo_monitoring.checks.adapters.PhotosRecyclerAdapter
...
class Step7_FinalPhotosFragments : Fragment() {
    ...
    fun onComplete(view: View?) {
        ...
        Observable.just(db)
            ...
            .subscribe {
                ...
                for (result in resultData.flowTransducerCheckLengthResults)
