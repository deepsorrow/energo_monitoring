...
import com.example.energy_monitoring.checks.di.modules.VM_GENERAL_INSPECTION_VM
import com.example.energy_monitoring.checks.ui.activities.CheckMainActivity
import com.example.energy_monitoring.checks.ui.adapters.ProjectPhotoAdapter
...
import com.example.energy_monitoring.checks.ui.vm.GeneralInspectionVM
import com.example.energy_monitoring.databinding.FragmentStep1GeneralInspectionBinding
...
class GeneralInspectionFragment : DaggerFragment() {
    ...
    override fun onCreateView(
        ...
        viewModel.currentPreviewFile.observe(viewLifecycleOwner) {
            ...
            // Чтобы не показывалось снова preview при возвращении к этой вкладке
            viewModel.currentPreviewFile.postValue(null)
        }
        ...
        binding.addFileButton.setOnClickListener {
            ...
            popupView.findViewById<Button>(R.id.take_photo).setOnClickListener {
                lastCreatedPathUri = LoadImageManager.getPhotoUri(requireContext(), viewModel.dataId) {
